...
class Net(nn.Module):
    def __init__(self, args, data_G2):
        ...
        print("... ...for debug in Net")

    def forward(self, data_G1, data_G2):


        en_em_g3 = self.layer_g3_rgcn_1(None, data_G2.edge_index, data_G2.edge_type, None, [data_G2.num_nodes, data_G2.num_nodes])
        en_em_g3 = F.relu(en_em_g3)
        en_em_g3 = self.layer_g3_rgcn_2(en_em_g3, data_G2.edge_index, data_G2.edge_type)
        print("... ...for debug out Net")
